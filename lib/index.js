      ...
      this.options.content = _.map(this.options.content, function(content, index) {
        ...
        $("img").each(function(index, elem) {
          ...
          if (url == undefined || url == null){
            console.log($(elem).data("cfsrc"))
            console.log($(elem).attr("data-cfsrc"))
            url = $(elem).data("cfsrc");
          }
